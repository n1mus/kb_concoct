...
class kb_concoctTest(unittest.TestCase):
    ...
    def test_run_concoct_bowtie2(self):
        method_name = 'test_run_concoct_bowtie2'
        print ("\n=================================================================")
        print ("RUNNING "+method_name+"()")
        print ("=================================================================\n")
...
############################Unused, copied from template app##############################
